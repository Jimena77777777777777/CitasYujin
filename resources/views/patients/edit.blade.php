        ...
        <div class="card-body">
            ...
            <form action="{{ url('/pacientes/.$patient->id') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control" value="{{ old('email', $pateint->email) }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <small class="text-warning"> Solo llena el campo si desea llenar la contraseña </small>
                </div>
